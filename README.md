...
<p align="center">
  ...
  <a href="https://goreportcard.com/report/github.com/hmqgg/go-orbit-db">
    <img src="https://goreportcard.com/badge/github.com/hmqgg/go-orbit-db"
         alt="Go Report Card">
  </a>
  ...
  <a href="https://godoc.org/github.com/hmqgg/go-orbit-db">
    <img src="https://godoc.org/github.com/hmqgg/go-orbit-db?status.svg"
         alt="GoDoc">
  </a>
</p>
...
* You need to use the canonical import: `github.com/hmqgg/go-orbit-db` instead of `github.com/berty/go-orbit-db`
...
$ go get github.com/hmqgg/go-orbit-db
[...]
$
```
